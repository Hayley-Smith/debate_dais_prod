...
class DebateProvider extends ChangeNotifier {
  ...
  final Debate _selectedDebate = Debate(
    isPublic: true,
    id: "1",
    thesis: "The existence of God is a logical fallacy.",
    openingStatement1:
  ...
  Debate get selectedDebate => _selectedDebate;
